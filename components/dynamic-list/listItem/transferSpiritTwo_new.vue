		...
		<view class="newBox">
			...
			<view class="info">
				...
				<view class="levelBox">
					...
					<image class="level" src="../../../static/spirit/level6.png" mode="widthFix" v-if="item.level==6"></image>
					<image class="level" src="../../../static/spirit/level7.png" mode="widthFix" v-if="item.level==7"></image>
					<image class="level" src="../../../static/spirit/level8.png" mode="widthFix" v-if="item.level==8"></image>
				</view>
				<view class="tBox">
					<view class="Child">
			...
			<view class="btnBox">
				<button class="btn" @click="operation(item)">轉化</button>
