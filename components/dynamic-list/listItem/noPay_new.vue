		...
		<view class="item">
			<view class="top">
				...
				<view class="right">
					...
					<view class="flex ii">
						<text class="num">上級: {{item.inviterName}}</text>
					</view>
				</view>
			</view>
			<view class="bottom">
				<view class="itemS">
					...
					<view class="viewC">
						...
						<view class="cI">
							<image v-if="item.level==1" src="../../../static/spirit/levelOne.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==2" src="../../../static/spirit/levelTwo.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==3" src="../../../static/spirit/levelThree.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==4" src="../../../static/spirit/levelFour.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==5" src="../../../static/spirit/levelFive.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==6" src="../../../static/spirit/level6.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==7" src="../../../static/spirit/level7.png" mode="widthFix"
								class="imgs"></image>
							<image v-if="item.level==8" src="../../../static/spirit/level8.png" mode="widthFix"
								class="imgs"></image>
						</view>
					</view>
					<view class="viewR">
						<view class="ro"><text class="time">{{item.remainingTime}}分鍾</text></view>
