    ...
    <view>
      ...
      >
        <view slot="content-list" class="list_content" :class="[`list_content ${columns === 2 ? 'columns' : ''}`]">
          <view v-for="(item, index) in list" :key="index" @click="handleJumpRoute(item)">
            <spirit
            ...
            <spirit-market-new
              v-if="getListItemKey() === 'spirit-market-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-history-new
              v-if="getListItemKey() === 'my-histort-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <more-representation-new
              v-if="getListItemKey() === 'more-representation-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <no-pay-new
              v-if="getListItemKey() === 'no-pay-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-book-spirit-new
              v-if="getListItemKey() === 'my-book-spirit-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-book-spirit-history-new
              v-if="getListItemKey() === 'my-book-spirit-history-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-match-spirit-new
              v-if="getListItemKey() === 'my-match-spirit-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-match-spirit-history-new
              v-if="getListItemKey() === 'my-match-spirit-history-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-adopt-spirit-new
              v-if="getListItemKey() === 'my-adopt-spirit-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-self-spirit-new
              v-if="getListItemKey() === 'my-self-spirit-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <my-self-spirit-history-new
              v-if="getListItemKey() === 'my-self-spirit-history-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <transfer-spirit-new
              v-if="getListItemKey() === 'transfer-spirit-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
            ...
            <transfer-spirit-two-new
              v-if="getListItemKey() === 'transfer-spirit-two-new'"
              :item="{
                ...item,
                ...getComponentBindData(item),
              }"
