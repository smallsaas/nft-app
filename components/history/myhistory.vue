    ...
    <view class="left">
      <view class="leftL">
        <view class="T">
          ...
          <view class="TB"
            ><image src="../../static/spirit/newCoin.png" mode="widthFix" class="img"></image><text class="infoT">x {{ coin || 0 }}</text></view
          >
        </view>
        <view class="B">
          <view class="btnbtn"><button class="btn" @click="transfer">轉讓</button></view>
          <view class="btnbtn"><button class="btn" @click="goTo">曆史記錄</button></view>
        </view>
      </view>
      <view class="leftR">
        <view class="item">
        ...
        <view class="item">
          ...
          <view class="TTT"
            ><image src="../../static/spirit/land.png" mode="widthFix" class="img"></image><text class="infoT">x {{ item.landRemainingDays || 0 }}</text></view
          >
        </view>
      </view>
    </view>
...
import changGuGu from './changGuGu.vue'
export default {
  props: {
    // 獲取
    item: {
  ...
  components: { number, transfer, transfercoin, toast, changGuGu },
  data () {
    return {
